...
const GroupSettings = () => {
    ...
    const isOwner = groupForEdit?.owner === user?._id;

    if (!groupForEdit) return null;

    return (
        <div className="flex h-full items-center justify-start md:flex-col w-full scrollable-container overflow-auto" style={{ backgroundColor: theme.secondary }}>
                                    ...
                                    <form className="grid max-w-2xl mx-auto mt-8" onSubmit={(e) => { e.preventDefault(); updateGroup(); }}>
                                        <div className="flex flex-col items-center space-y-5 sm:flex-row sm:space-y-0">
                                            <img
                                                ...
                                                src={
                                                    profileImage ? URL.createObjectURL(profileImage) : groupForEdit?.profileImage
                                                }
                                                alt="Profile"
                                            />
